...
curl -L https://github.com/block-mesh/block-mesh-monorepo/releases/download/v0.0.415/blockmesh-cli-x86_64-unknown-linux-gnu.tar.gz -o blockmesh-cli.tar.gz || { echo "BlockMesh CLI download failed!"; exit 1; }
